    ...
    try {
        ...
        if (typeof fbq === 'function') {
            ...
            fbq('track', 'Purchase', {
                ...
                value: totalPrice || 599, // استخدام قيمة افتراضية إذا لم يتم العثور على السعر
                currency: 'EGP'
            });
        ...
        if (typeof ttq === 'object' && typeof ttq.track === 'function') {
            ...
            ttq.track('CompletePayment', {
                ...
                value: parseFloat(document.getElementById('totalPrice').textContent.replace(/[^0-9.-]+/g, '')) || 599,
                currency: 'EGP'
            });

...
function updateProductPreviewFixed(productItem, color) {
    ...
    if (previewImg) {
        ...
        switch (color) {
            case 'black':
                imagePath = 'Public/images/order-color/black-tshirt.jpg';
                break;
            case 'beige':
                imagePath = 'Public/images/order-color/beige-tshirt.jpg';
                break;
            case 'silver':
                imagePath = 'Public/images/order-color/silver-tshirt.jpg';
                break;
            default:
                imagePath = 'Public/images/order-color/black-tshirt.jpg';
        }
